...
export default function EditTrip({ trip, vehicles, customers, onEditTrip, onCancel }) {
  ...
  const handleSubmit = (e) => {
    ...
    if (sourceID && destID && parseInt(sourceID, 10) === parseInt(destID, 10)) {
      ...
      <div className="d-flex align-items-center gap-2 mb-4">
        ...
        <div>
          <h5 className="mb-0 fw-bold">
            <i className="fas fa-edit me-2 text-primary"></i>Modify Trip Schedule
          </h5>
          <p className="text-muted small mb-0">Update dispatch routing details and weight requirements</p>
        </div>
      </div>
          ...
          <div className="col-lg-8">
            <div className="card border-0 shadow-sm p-4" style={{ borderRadius: '16px' }}>
              <div className="row g-3">
                ...
                {/* Trip Status */}
                <div className="col-md-6">
                  <label className="form-label fw-semibold">Trip Status</label>
                  <div className="input-group">
