...
export default function EditVehicle({ vehicle, onEditVehicle, onCancel }) {
  ...
  // Prepopulate form on mount or vehicle update
  useEffect(() => {
    if (vehicle) {
      setPlateNo(vehicle.plate_no || '');
      setVehicleType(vehicle.vehicle_type || 'Bus');
      setFuelType(vehicle.fuel_type || 'petrol');
      setMaxCapacity(vehicle.maxloadcapacity !== null ? vehicle.maxloadcapacity.toString() : '');
      setOdometer(vehicle.odometer !== null ? vehicle.odometer.toString() : '0');
      setCost(vehicle.acquisition_cost !== null ? vehicle.acquisition_cost.toString() : '');
      ...
      <div className="d-flex align-items-center gap-2 mb-4">
        ...
        <div>
          <h5 className="mb-0 fw-bold">
            <i className="fas fa-edit me-2 text-primary"></i>Edit Vehicle Profile
          </h5>
          <p className="text-muted small mb-0">Update fleet record information and status</p>
        </div>
      </div>
